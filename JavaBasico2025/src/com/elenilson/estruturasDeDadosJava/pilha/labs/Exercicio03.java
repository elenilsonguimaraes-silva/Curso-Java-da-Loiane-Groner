...
public class Exercicio03 {
	...
	public static void main(String[] args) {
		Pilha<Livro> pilhaDeLivros = new Pilha<Livro>(20);
		...
		System.out.println("Pilha de livros criada, pilha está vazia? " + pilhaDeLivros.estaVazia());
		...
		System.out.println(pilhaDeLivros.tamanho() + " Livros foram empilhados:");
		System.out.println(pilhaDeLivros);
		
		System.out.println("Pilha de livros criada, pilha está vazia " + pilhaDeLivros.estaVazia());
		
		System.out.println("Espiando o topo da pilha " + pilhaDeLivros.topo());
		
		System.out.println("Desempilhando livros da pilha:");
		
		while(!pilhaDeLivros.estaVazia()) {
			System.out.println("Desempilhando livro: " + pilhaDeLivros.desempilha());
		}
		System.out.println("Todos os livros foram desempilhados, pilha vazia: " + pilhaDeLivros.estaVazia());
	}
