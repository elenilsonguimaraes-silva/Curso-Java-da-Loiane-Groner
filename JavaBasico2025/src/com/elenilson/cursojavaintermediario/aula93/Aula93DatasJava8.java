package com.elenilson.cursojavaintermediario.aula93;
...
public class Aula93DatasJava8 {
	...
	public static void main(String[] args) {
		...
		System.out.println(LocalDate.parse("2026-02-01").isLeapYear());
		...
		System.out.println(LocalDateTime.of(2019, 2, 16, 20, 10));
