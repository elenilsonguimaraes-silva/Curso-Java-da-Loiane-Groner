package com.elenilson.cursojavaintermediario.aula63;
...
public class ExemploPrintf {
	...
	public static void main(String[] args) {
		...
		double prontoFlutuante = 3.1456789;
		System.out.printf("%f", prontoFlutuante);
		...
		System.out.printf("R$%10.2f", prontoFlutuante);
