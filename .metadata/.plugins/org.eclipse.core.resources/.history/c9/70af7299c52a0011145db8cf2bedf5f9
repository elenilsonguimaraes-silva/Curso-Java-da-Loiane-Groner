package com.elenilson.estruturaDeDadosJava.vetor.labs;

import java.util.Scanner;

import com.elenilson.estruturaDeDadosJava.vetor.teste.Contato;
import com.elenilson.estruturasDeDadosJava.vetor.Lista;
...
public class Exercicio06 {
	...
	private static void excluirPorPosicao(Scanner scan, Lista<Contato> lista) {
		...
		try {			
			...
			System.out.println("Posição inválida, busca cancelada!");
		}
	}
	...
	private static void pesquisarContatoExiste(Scanner scan, Lista<Contato> lista) {
		int pos = lerInformacaoInt("Entre com a posição da busca  do contato a ser pesquisada"
				+ "", scan);
	...
	private static void pesquisarUltimoIndice(Scanner scan, Lista<Contato> lista) {
		...
		try {
			...
			System.out.println("Contato encontrado na posiação " + pos);
		} catch (Exception e) {
			System.out.println("Posição inválida, busca cancelada!");
		}
	}
	...
	private static int obterOpcaoMenu(Scanner scan) {
		...
		while(!entradaValida) {
			...
			System.out.println("3: Consulta ou busca de contato de uma posição específica:");
	...
	private static void criarContatosDinamicamente(int quantidade, Lista<Contato> lista) {
		...
		for(int i=1; i < quantidade; i++) {
			contato = new Contato("Contato"+ i , i+"1234-4567", "contato"+i+"@email.com");
			lista.adiciona(contato);
